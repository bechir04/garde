...
كل المعتمديات</option>
      ...
      {statsOrder.map((section) => {
        if (!settings.stats[section]) return null;
        if (section === 'kpi') return (
          <div key="kpi" className="kpi-grid">
        ...
        if (section === 'map') return (
          <div key="map" className="card" style={{ marginBottom: 24, cursor: 'pointer', overflow: 'hidden' }} onClick={() => navigate('/map')}>
            ...
            <div style={{ height: 280, background: 'linear-gradient(135deg, #f0f4f8 0%, #d4e6f1 50%, #a9cce3 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: 12, right: 12, background: '#fff', borderRadius: 8, padding: '8px 12px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', fontSize: 11 }}>
        ...
        if (section === 'govBar') return (
          <div key="govBar" className="chart-card" style={{ marginBottom: 24 }}>
        ...
        if (section === 'causePie') return (
          <div key="causePie" className="chart-card" style={{ marginBottom: 24 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        if (section === 'brandBar') return (
          <div key="brandBar" className="chart-card" style={{ marginBottom: 24 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        if (section === 'hourBar') return (
          <div key="hourBar" className="chart-card" style={{ marginBottom: 24 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        if (section === 'trendLine') return (
          <div key="trendLine" className="chart-card" style={{ marginBottom: 24 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
